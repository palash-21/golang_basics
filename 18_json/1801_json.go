...
type response2 struct {
	Page   int      `json:"page"` // You can use tags on struct field declarations to customize the encoded JSON key names (Page --> page, Fruits --> fruits)
...
func main() {
	...
	res := response2{}
	// We use json.Unmarshal, passing it a []byte of JSON data and a pointer to a variable where the JSON package can put the decoded data
